...
/*   Updated: 2024/02/16 20:41:16 by ugdaniel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (state.sort_type == sort_by_time)
...
void	list_contents(t_list *list, int *add_newline)
{
	t_list *file = list;
